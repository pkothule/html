...
//  <div class="card">
//  <figure class="moviecard mb-4">
//      <img src="https://image.tmdb.org/t/p/w1280${movie.backdrop_path}" alt="movies.title">
...
const imgUrl = "https://image.tmdb.org/t/p/w1280";
  ...
  movieData = movieArr.map(function (movie) {
    result += `<div class="col-lg-3 col-md-6 col-xs-12">
                ...
                return `${imgUrl} ${movie.backdrop_path} ${movie.title}`;
  })
  cl(movieData);
  moviesContainer.innerHTML = result;
